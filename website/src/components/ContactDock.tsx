...
const dockItems = [
    { icon: Mail, label: 'Email', href: 'mailto:ian@ianochieng.ai' },
    { icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/ian-ochieng-ai' },
    ...
    return (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50">
            <motion.div
                ...
                className="glass-panel px-4 py-3 rounded-2xl flex items-center gap-4 border border-white/20 shadow-2xl backdrop-blur-xl bg-white/30"
            >
                {dockItems.map((item) => (
                    <motion.a
                        key={item.label}
                        ...
                        whileTap={{ scale: 0.9 }}
                        className="p-3 rounded-xl bg-white/40 hover:bg-white/80 transition-colors relative group"
