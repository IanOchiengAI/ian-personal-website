...
import { Youtube, BookOpen, ArrowUpRight, Palette, Sparkles } from 'lucide-react';
...
const ecosystemItems = [
    ...
    },
    {
        ...
        description: 'Step-by-step guides on building and shipping AI products in emerging markets.',
    ...
    },
    {
        ...
        title: 'Before AGI',
        subtitle: 'SUBSTACK',
        description: 'Long-form analysis on the future of autonomous systems and identity.',
                ...
                <div className="grid md:grid-cols-2 gap-6 auto-rows-[minmax(300px,auto)]">
                    {ecosystemItems.map((item, idx) => {
                        ...
                        const extraProps = isLink ? {
                            ...
                            onClick: item.action === 'openPricing' ? onOpenPricing : undefined
                        };
                            ...
                            >
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        <div className={`flex items-center gap-3 text-sm font-medium ${item.theme === 'orange' ? 'text-orange-600' :
                                            item.theme === 'blue' ? 'text-blue-200' :
                                                item.theme === 'red' ? 'text-red-200' : 'text-slate-300'
                                            }`}>
                                ...
                                <div className="relative z-10 mt-auto pt-6">
                                    <span className={`inline-flex items-center gap-2 font-medium group-hover:gap-3 transition-all ${item.theme === 'orange' ? 'text-orange-600' : 'text-white'
                                        ...
                                        {item.action === 'openPricing' ? 'Open Tiers' :
                                            item.id === 'before-agi' ? 'Read Analysis' :
                                                item.id === 'behance' ? 'View Portfolio' : 'Watch Guides'}
